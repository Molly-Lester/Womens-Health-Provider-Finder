...
### Tapiwa Chibagidi
- Responsible for project documentation and testing. This included writing and maintaining clear written documentation of the project and ensuring the process was clearly explained for both technical and non-technical readers. In addition, Tapiwa developed unit tests using Vitest and React Testing Library to test frontend components, helping ensure the application behaved as expected and reducing the likelihood of bugs.
