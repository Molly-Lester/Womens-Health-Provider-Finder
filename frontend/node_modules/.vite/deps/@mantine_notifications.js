...
import { Ca as ReactRemoveScroll, Do as useProps, Fo as useMantineTheme, Fs as useReducedMotion, Ha as OptionalPortal, Is as useMergedRef, It as Notification, Ls as useForceUpdate, Rs as useDidUpdate, ao as Box, do as getStyleObject, ec as getDefaultZIndex, lc as rem, so as factory, ws as createVarsResolver, yo as useStyles, zs as randomId } from "./esm-DZIlMbtn.js";
		...
		acc[pos] = grouped[pos].map(({ style: notificationStyle, ...notification }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Transition$1, {
			...
			children: (state) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NotificationContainer, {
				ref: (node) => {
					...
					else delete refs.current[notification.id];
				},
				data: notification,
