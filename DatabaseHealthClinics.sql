...
-- Table structure for table `clinicconcerns`
--
...
CREATE TABLE `clinicconcerns` (
  ...
  CONSTRAINT `clinicconcerns_ibfk_1` FOREIGN KEY (`clinic_id`) REFERENCES `clinics` (`clinic_id`),
  CONSTRAINT `clinicconcerns_ibfk_2` FOREIGN KEY (`concern_id`) REFERENCES `health_concerns` (`concern_id`)
);


INSERT INTO `clinicconcerns` 
VALUES 
(3,100),
(9,100),
(11,100),
...
CREATE TABLE `clinics` (
  ...
  `clinic_type` enum('NHS','Private') DEFAULT NULL,
...
(6,'Mortimor Market Centre Sexual Health Clinic London','NHS','Capper Street, London','WC1E 6JB',51.522722,-0.135518,'https://www.sexualhealth.cnwl.nhs.uk/clinic/mortimer-market-centre-including-margaret-pyke-centre/','020 3317 5252'),
(7,'Guy''s Assisted Conception Unit','NHS','Guy''s Hospital, Great Maze Pond, London','SE19RT',51.503331,-0.086771,'https://www.guysandstthomas.nhs.uk/our-services/assisted-conception-unit-acu','02071882300'),
...
CREATE TABLE `health_concerns` (
  `concern_name` varchar(255) DEFAULT NULL,
  `concern_id` int NOT NULL,
...
VALUES 
('Women''s general health',100,NULL),
('Family planning and contraception',101,NULL),
('Sexual health',102,NULL),
('Fertility support',103,NULL),
('Pregnancy and maternity care',104,NULL),
('Menopause support',105,NULL);
